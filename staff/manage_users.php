<?php
// project-root/staff/manage_users.php
        ...
        if (isset($_POST['action'])) {
            ...
            if ($action == 'add' || $action == 'edit') {
                ...
                if (empty($username) || empty($email) || empty($role_id)) {
                    ...
                    redirect(ROOT_URL . 'staff/manage_users.php');
                    exit();
                }
                ...
                // Pencegahan: Jangan biarkan staff menghapus akunnya sendiri
...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <form id="userForm" action="<?php echo ROOT_URL; ?>staff/manage_users.php" method="POST">
                        ...
                        <?php foreach ($all_users as $user): ?>
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-6 text-center whitespace-nowrap">
                                    ...
                                    <form action="<?php echo ROOT_URL; ?>staff/manage_users.php" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?');">
