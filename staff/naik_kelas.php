<?php
// project-root/staff/naik_kelas.php
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] === 'naik_kelas') {
        ...
        if (empty($kelas_asal_id_post)) {
            ...
            redirect(ROOT_URL . 'staff/naik_kelas.php');
        }
        ...
        if ($is_final_year_class) {
            ...
            if (empty($kelas_tujuan_id_post)) {
                ...
                redirect(ROOT_URL . 'staff/naik_kelas.php?kelas_asal_id=' . $kelas_asal_id_post);
            }
            if (!empty($siswa_terpilih_ids)) {
        ...
        redirect(ROOT_URL . 'staff/naik_kelas.php'); // Redirect kembali ke halaman ini tanpa query params
    }
