<?php
// project-root/staff/manage_whatsapp_queue.php
...
try {
    ...
    if (isset($_GET['action']) && isset($_GET['id'])) {
        ...
        header('Location: ' . ROOT_URL . 'staff/manage_whatsapp_queue.php?status=' . urlencode($filter_status) . '&page=' . $page . '&search=' . urlencode($search_term));
        exit;
    }
