<?php
// project-root/staff/manage_jadwal.php
...
try {
    ...
    if (isset($_POST['action'])) {
        ...
        redirect(ROOT_URL . 'staff/manage_jadwal.php');
    }
}
...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <form id="jadwalForm" action="<?php echo ROOT_URL; ?>staff/manage_jadwal.php" method="POST">
                                        ...
                                        <?php foreach ($schedules_for_day as $jadwal): ?>
                                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                                ...
                                                <td class="py-3 px-6 text-center whitespace-nowrap">
                                                    ...
                                                    <form action="<?php echo ROOT_URL; ?>staff/manage_jadwal.php" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus jadwal ini? Tindakan ini akan menghapus semua data absensi guru dan siswa yang terkait secara permanen!');">
