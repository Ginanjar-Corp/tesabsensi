<?php
// project-root/staff/manage_guru.php
            ...
            if ($action == 'import') {
                ...
                if (isset($_FILES['excel_file']) && $_FILES['excel_file']['error'] == UPLOAD_ERR_OK) {
                    ...
                    if (!in_array(strtolower($file_extension), $allowed_extensions)) {
                        ...
                        redirect(ROOT_URL . 'staff/manage_guru.php');
                    }
                    ...
                    try {
                        ...
                        for ($i = 2; $i <= count($sheetData); $i++) {
                            ...
                            // Bersihkan dan konversi gaji_per_pertemuan
    ...
    <div class="bg-white shadow-md rounded-lg p-6 mb-8">
        ...
        <form action="manage_guru.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <p class="text-xs text-gray-500 mt-1">Pastikan file Excel memiliki kolom: Nama Lengkap, NIP, RFID Tag, Tempat Lahir, Tanggal Lahir (YYYY-MM-DD), Jenis Kelamin, Alamat, No. Telepon, Email, Gaji Per Pertemuan, Aktif (Ya/Tidak).</p>
            </div>
            ...
            <table class="min-w-full bg-white">
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    <?php if (empty($all_guru)): ?>
                        <tr>
                            <td colspan="8" class="py-3 px-6 text-center">Tidak ada data guru.</td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($all_guru as $guru): ?>
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left"><?php echo htmlspecialchars($guru['nip'] ?? '-'); ?></td>
                                ...
                                <td class="py-3 px-6 text-left"><?php echo htmlspecialchars($guru['email'] ?? '-'); ?></td>
...
<script>
    ...
    document.getElementById('gaji_per_pertemuan').addEventListener('input', function(e) {
        ...
        // Untuk tampilan, kita bisa gunakan NumberFormat API
        // Namun, untuk input yang masih diketik, biarkan raw agar mudah diedit
        // Ini hanya contoh sederhana, untuk formatting yang lebih robust mungkin butuh library
        // atau logika yang lebih kompleks. Untuk saat ini, biarkan seperti ini agar mudah di-parse PHP.
        // e.g., if (value.length > 0) { e.target.value = new Intl.NumberFormat('id-ID').format(parseFloat(value)); }
    });
</script>
