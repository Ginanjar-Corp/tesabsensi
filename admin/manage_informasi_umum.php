<?php
// project-root/admin/manage_informasi_umum.php
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        header('Location: ' . ROOT_URL . 'admin/manage_informasi_umum.php');
        exit;
    }
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <form action="" method="POST" class="space-y-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php if ($edit_informasi): ?>
                    <a href="<?php echo ROOT_URL; ?>admin/manage_informasi_umum.php" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">
                        Batal
                    </a>
                <?php endif; ?>
            </div>
                        ...
                        <?php foreach ($informasi_data as $info): ?>
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-6 text-center whitespace-nowrap">
                                    <a href="<?php echo ROOT_URL; ?>admin/manage_informasi_umum.php?action=edit&id=<?php echo htmlspecialchars($info['id']); ?>" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
                                    <a href="<?php echo ROOT_URL; ?>admin/manage_informasi_umum.php?action=delete&id=<?php echo htmlspecialchars($info['id']); ?>" class="text-red-600 hover:text-red-900" onclick="return confirm('Apakah Anda yakin ingin menghapus informasi ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
