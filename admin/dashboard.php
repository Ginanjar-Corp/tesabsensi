...
?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 flex items-center justify-between border border-gray-200 hover:shadow-lg transition duration-300">
                <div>
                    <p class="text-sm text-gray-500 uppercase font-semibold">Siswa Belum Absen Hari Ini</p>
    ...
    <div class="table-container overflow-y-auto max-h-96 overflow-x-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                ...
                <div class="space-y-4">
                    <a href="<?php echo ROOT_URL; ?>admin/laporan_absensi_gerbang_siswa.php" class="flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition duration-300 border border-gray-100">
                        <span class="text-gray-700 font-medium">Absensi Siswa (Gerbang)</span>
                        <i class="fas fa-chart-line text-blue-500"></i>
                    </a>
                    <a href="<?php echo ROOT_URL; ?>admin/laporan_absensi_mapel_siswa.php" class="flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition duration-300 border border-gray-100">
                        <span class="text-gray-700 font-medium">Absensi Siswa (Mapel)</span>
                        <i class="fas fa-chart-bar text-green-500"></i>
                    </a>
                    <a href="<?php echo ROOT_URL; ?>admin/laporan_absensi_gerbang_guru.php" class="flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition duration-300 border border-gray-100">
                        <span class="text-gray-700 font-medium">Absensi Guru (Gerbang)</span>
                        <i class="fas fa-chart-pie text-red-500"></i>
                    </a>
                    <a href="<?php echo ROOT_URL; ?>admin/laporan_absensi_mapel_guru.php" class="flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition duration-300 border border-gray-100">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                ...
                <div class="space-y-4">
                    <a href="<?php echo ROOT_URL; ?>admin/absensi_gerbang.php" class="flex items-center justify-between p-4 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition duration-300 shadow-md">
                        <span class="font-medium">Mulai Absen Datang</span>
                        <i class="fas fa-fingerprint"></i>
                    </a>
                    <a href="<?php echo ROOT_URL; ?>admin/absensi_gerbang_pulang.php" class="flex items-center justify-between p-4 bg-green-500 hover:bg-green-600 text-white rounded-lg transition duration-300 shadow-md">
                        <span class="font-medium">Mulai Absen Pulang</span>
                        <i class="fas fa-fingerprint"></i>
                    </a>
                    <a href="<?php echo ROOT_URL; ?>admin/settings/school_settings.php" class="flex items-center justify-between p-4 bg-purple-500 hover:bg-purple-600 text-white rounded-lg transition duration-300 shadow-md">
                        <span class="font-medium">Pengaturan Sekolah</span>
                        <i class="fas fa-cog"></i>
                    </a>
                    <a href="<?php echo ROOT_URL; ?>admin/naik_kelas.php" class="flex items-center justify-between p-4 bg-red-500 hover:bg-red-600 text-white rounded-lg transition duration-300 shadow-md">
