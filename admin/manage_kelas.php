<?php
// project-root/admin/manage_kelas.php
        ...
        if (isset($_POST['action'])) {
            ...
            if ($action == 'add') {
                ...
                if (empty($nama_kelas)) {
                    ...
                    redirect(ROOT_URL . 'admin/manage_kelas.php');
                }
...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <form id="kelasForm" action="<?php echo ROOT_URL; ?>admin/manage_kelas.php" method="POST">
                        ...
                        <?php foreach ($all_kelas as $kelas): ?>
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-6 text-center whitespace-nowrap">
                                    ...
                                    <form action="<?php echo ROOT_URL; ?>admin/manage_kelas.php" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kelas ini? Menghapus kelas dapat berdampak pada data siswa yang terkait.!');">
