<?php
// project-root/admin/manage_tahun_ajaran.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    redirect(ROOT_URL . 'admin/manage_tahun_ajaran.php');
}
...
?>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8 border border-gray-200">
            ...
            ?>
            <form action="<?php echo ROOT_URL; ?>admin/manage_tahun_ajaran.php" method="POST" class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <?php if (isset($_GET['edit'])): ?>
                        <a href="<?php echo ROOT_URL; ?>admin/manage_tahun_ajaran.php"
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center space-x-2">
                                            <a href="<?php echo ROOT_URL; ?>admin/manage_tahun_ajaran.php?edit=<?php echo $ta['id']; ?>"
                                            ...
                                            <?php if (!$ta['is_active']): ?>
                                                <a href="<?php echo ROOT_URL; ?>admin/manage_tahun_ajaran.php?set_active=<?php echo $ta['id']; ?>"
                                                ...
                                                <a href="<?php echo ROOT_URL; ?>admin/manage_tahun_ajaran.php?delete=<?php echo $ta['id']; ?>"
