<?php
// project-root/admin/manage_siswa.php
        ...
        if ($action === 'import') {
            ...
            if (isset($_FILES['excel_file']) && $_FILES['excel_file']['error'] == UPLOAD_ERR_OK) {
                ...
                if (!in_array(strtolower($file_extension), $allowed_extensions)) {
                    ...
                    redirect(ROOT_URL . 'admin/manage_siswa.php');
                }
                        ...
                        <?php foreach ($list_siswa as $siswa): ?>
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <a href="<?php echo ROOT_URL; ?>admin/manage_siswa.php?action=edit_form&id=<?php echo htmlspecialchars($siswa['id']); ?>" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-3 rounded-lg text-xs">Edit</a>
                                    <a href="<?php echo ROOT_URL; ?>admin/manage_siswa.php?action=delete&id=<?php echo htmlspecialchars($siswa['id']); ?>" class="bg-red-500 hover:bg-red-600 text-white font-bold py-1 px-3 rounded-lg text-xs" onclick="return confirm('Apakah Anda yakin ingin menghapus siswa ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
