<?php
// project-root/admin/manage_absensi_guru.php
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'record_absensi') {
        ...
        redirect(ROOT_URL . 'admin/manage_absensi_guru.php?tanggal=' . urlencode($tanggal_absensi) . '&tahun_ajaran=' . urlencode($selected_tahun_ajaran) . '&semester=' . urlencode($selected_semester));
    }
