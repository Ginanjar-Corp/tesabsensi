<?php
// project-root/admin/manage_mapel.php
        ...
        if (isset($_POST['action'])) {
            ...
            if ($action == 'add') {
                ...
                if (empty($nama_mapel)) {
                    ...
                    redirect(ROOT_URL . 'admin/manage_mapel.php');
                }
...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <form id="mapelForm" action="<?php echo ROOT_URL; ?>admin/manage_mapel.php" method="POST">
                        ...
                        <?php foreach ($all_mapel as $mapel): ?>
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-6 text-center whitespace-nowrap">
                                    ...
                                    <form action="<?php echo ROOT_URL; ?>admin/manage_mapel.php" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus mata pelajaran ini? Tindakan ini akan menghapus semua jadwal dan data absensi yang terkait secara permanen!');">
