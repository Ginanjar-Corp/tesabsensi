<?php
// project-root/admin/manage_sorogan_siswa.php
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_POST['action'])) {
            ...
            // tahun_ajaran_id akan diisi otomatis di kelas SoroganSiswa::create() atau update()
            ...
            $sorogan_model->nilai = !empty($_POST['nilai']) ? $_POST['nilai'] : null;
        ...
        header('Location: ' . ROOT_URL . 'admin/manage_sorogan_siswa.php');
        exit;
    }

    // Handle delete request
    if (isset($_GET['action']) && $_GET['action'] === 'delete' && isset($_GET['id'])) {
        if ($sorogan_model->delete($_GET['id'])) {
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <form action="" method="POST" class="space-y-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php if ($edit_sorogan): ?>
                    <a href="<?php echo ROOT_URL; ?>admin/manage_sorogan_siswa.php" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">
                        Batal
                    </a>
                <?php endif; ?>
            </div>
                        ...
                        <?php foreach ($sorogan_data as $sorogan): ?>
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-6 text-center whitespace-nowrap">
                                    <a href="<?php echo ROOT_URL; ?>admin/manage_sorogan_siswa.php?action=edit&id=<?php echo htmlspecialchars($sorogan['id']); ?>" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
                                    <a href="<?php echo ROOT_URL; ?>admin/manage_sorogan_siswa.php?action=delete&id=<?php echo htmlspecialchars($sorogan['id']); ?>" class="text-red-600 hover:text-red-900" onclick="return confirm('Apakah Anda yakin ingin menghapus catatan sorogan ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
