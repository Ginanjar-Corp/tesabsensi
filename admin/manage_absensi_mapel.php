<?php
// project-root/admin/manage_absensi_mapel.php
                            ...
                            <?php foreach ($jadwal_hari_ini as $jadwal): ?>
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <a href="<?php echo ROOT_URL; ?>admin/catat_absensi_mapel.php?jadwal_id=<?php echo htmlspecialchars($jadwal['id']); ?>" class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded text-xs">Catat Absensi</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
