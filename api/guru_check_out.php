<?php
// project-root/api/guru_check_out.php
...
try {
    ...
    // Validasi token yang lebih kuat
    ...
    // Proses absensi pulang menggunakan metode baru
    $absen_result = $absensi_model->absenKeluarGuru($guru_id);
    ...
    if ($absen_result['success']) {
        ...
        $tipe_absensi_teks = 'pulang';
        $status_kehadiran = $absen_result['status'] ?? 'Pulang'; // Ambil status dari hasil absenKeluarGuru()
    ...
    error_log('Error in guru_check_out.php: ' . $e->getMessage());
}